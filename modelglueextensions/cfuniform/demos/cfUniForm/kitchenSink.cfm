...
<cfsilent>
<!--- 
filename:		cfUniForm/demos/kitchenSink.cfm
date created:	10/1/2008
author:			Matt Quackenbush (http://www.quackfuzed.com)
purpose:		I demonstrate most of the features of the cfUniForm tag library
...
<cfparam name="form.password2" type="string" default="" />
<cfparam name="form.firstName" type="string" default="" />
<cfparam name="form.lastName" type="string" default="" />
<cfparam name="form.skillsInterests" type="string" default="" />
<cfparam name="form.skillsInterests2" type="string" default="" />
<cfparam name="form.screenName" type="string" default="" />
<cfparam name="form.age" type="string" default="" />
<cfparam name="form.displayOptions" type="string" default="" />
<cfparam name="form.country" type="string" default="" />
<cfparam name="form.state" type="string" default="TX" />
<cfparam name="form.address" type="string" default="" />
...
<cfparam name="form.cellPhone" type="string" default="" />
<cfparam name="form.gender" type="string" default="" />
<cfparam name="form.aboutYou" type="string" default="" />

<cfscript>
	// let's create an error struct for the sake of demonstration
	errs = structNew();
	errs.password = "Passwords don't match.";
	errs.country = "Please select the country in which you reside.";
	errs.phone = "Please provide your telephone number.";
</cfscript>
</cfsilent>
...
<head>
	...
	<title>cfUniForm Kitchen Sink Demo</title>
</head>

<body>

<p>
	This page displays the "Kitchen Sink" demo form.  View the 
	<a href="kitchenSinkCode.cfm">code used to generate the form</a>.
</p>
<ul>
		...
		<uform:form action="#cgi.script_name#"
			...
			<uform:fieldset legend="Required Fields">
				...
				<uform:field label="Skills and Interests" 
							...
							hint='Enter your skills and interests by terms separated with commas (E.g. computers, GTD, running). Will be presented on your profile as a <a href="http://en.wikipedia.org/wiki/Tag_cloud" title="Definition of a tag cloud on Wikipedia">tag cloud</a>.' />
				...
				<uform:field label="Display Options" 
							name="displayOptions" 
							type="checkboxgroup"><!--- this is a checkboxgroup, so the submitted form will result in a comma-delimmited list of values (one for each item that is checked) --->
			...
			<uform:fieldset legend="Optional Fields" 
				...
				<p>This fieldset has the class <code>blockLabels</code> applied to it, and as a result we get a different form layout.</p>
				...
				<uform:field name="newsletter" 
							...
							type="checkbox" 
							value="1" 
							isChecked="#structKeyExists(form, 'newsletter')#" /><!--- regular checkbox; it will either exist or not exist when the form is submitted --->
				...
				<uform:field name="i_agree" 
							...
							value="1" 
							type="checkbox" 
							isChecked="#structKeyExists(form, 'i_agree')#" /><!--- regular checkbox; it will either exist or not exist when the form is submitted --->
			</uform:fieldset>
		</uform:form>
	</div>
</div>
...
<ul>
	<li><a href="kitchenSinkCode.cfm">View the code</a></li>
	<li><a href="index.cfm">Back to the cfUniForm demo home</a></li>
	<li><a href="http://cfuniform.riaforge.org/">Download cfUniForm from RIAForge.org</a></li>
	<li><a href="http://www.quackfuzed.com/index.cfm/UniForm-Tag-Library">View my blog</a></li>
</ul>
