...
This file is part of Model-Glue 'Gesture' 3.2 (3.2.492).
...
<cfset bootstrapper.coldspringPath = "/ModelGlue/tests/unittests/gesture/ColdSpring.xml" />
<cfset bootstrapper.coreColdspringPath = "/ModelGlue/tests/unittests/gesture/ColdSpring.xml" />
...
<cfset mg.getInternalBean("modelglue.ModuleLoaderFactory").create("XML").load( mg, expandPath("/ModelGlue/tests/unittests/gesture/primaryModule.xml") ) />
