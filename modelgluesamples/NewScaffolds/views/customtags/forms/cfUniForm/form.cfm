...
<cfscript>
	_config = structNew();
	_config.jQuery = "library/js/jQuery/jquery-1.3.2.min.js";
	_config.renderer = "../renderValidationErrors.cfm";
	_config.uniformCSS = "library/css/uni-form.css";
	_config.uniformCSSie = "library/css/uni-form-ie.css";
	_config.uniformJS = "library/js/jQuery/forms/uni-form.jquery.js";
	_config.validationJS = "library/js/jQuery/forms/jquery.validate-1.5.1.min.js";
	_config.dateCSS = "library/css/jquery.ui.datepicker.css";
	_config.dateJS = "library/js/jQuery/forms/ui.datepicker.packed.js";
	_config.timeCSS = "library/css/jquery.timeentry.css";
	_config.timeJS = "library/js/jQuery/forms/jquery.timeentry-1.4.2.min.js";
	_config.maskJS = "library/js/jQuery/forms/jquery.maskedinput-1.2.1.pack.js";
	_config.textareaJS = "library/js/jQuery/forms/jquery.prettyComments-1.4.js";
</cfscript>
...
<!--- 
<cfif len(attributes.cancelAction) GT 0>$("button[name='cancel']").click(function() { window.location.href='<cfoutput>#attributes.cancelAction#</cfoutput>'; return false; });</cfif>
 --->
...
<cfif thisTag.executionMode IS "end">
	...
	<cfoutput><!-- rendered by cfUniForm v3.4 (http://www.quackfuzed.com/demos/cfUniForm/) --><form action="#attributes.action#" method="#attributes.method#" enctype="#_enctype#" id="#attributes.id#" class="uniForm"></cfoutput>
	...
	<cfoutput>#__generatedContent#</cfoutput>
		...
		<cfsavecontent variable="_stdCSS">
			<cfoutput><link href="#_config.uniformCSS#" type="text/css" rel="stylesheet" media="all" /><!--[if lte ie 8]><link href="#_config.uniformCSSie#" type="text/css" rel="stylesheet" media="all" /><![endif]--></cfoutput>
		</cfsavecontent>
	...
	<cfif attributes.showSubmit>
		...
		<cfif attributes.showCancel>
			<cfoutput>&nbsp;<button class="submitButton cancel" name="cancel">#attributes.cancelValue#</button></cfoutput>
		</cfif>
