...
<cfsilent>
	...
	<cfsavecontent variable="tableSorterInit"> <!--- TableSorter jquery requirements --->
		...
		$(document).ready(function() {
			$("#<cfoutput>#tableId#</cfoutput>")
				.tablesorter({widthFixed: true, widgets: ["zebra"]})
				.tablesorterPager({container: $("#<cfoutput>#pagerContainer#</cfoutput>"), size: 5});
		});
		</script>
	</cfsavecontent>
				...
				<cfelseif isStruct(attributes.theList)>
					<cfloop collection="#attributes.theList#" item="theObject">
						<tr>	
				        	...
				        	<td><a href="#attributes.editEvent#<cfloop list='#attributes.primaryKeyList#' index='pk'>&#pk#=#evaluate('attributes.theList[theObject].get#pk#()')#</cfloop>">Edit</a></td>
				        	<td><a href="#attributes.deleteEvent#<cfloop list='#attributes.primaryKeyList#' index='pk'>&#pk#=#evaluate('attributes.theList[theObject].get#pk#()')#</cfloop>">Delete</a></td>
						</tr>
					</cfloop>
