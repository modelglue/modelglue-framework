...
<cfset widget.WidgetTypeQuery = viewstate.getValue("widget.WidgetTypeQuery") />
...
<tbody>
<cfif not widget.WidgetTypeQuery.recordcount>
	<tr>
		<cfoutput><td colspan="#displayedColumns#"><em>No Records</em></td></cfoutput>
	</tr>
</cfif>
<cfoutput query="widget.WidgetTypeQuery">
	<cfset keyString = "&widgetTypeId=#urlEncodedFormat(widget.WidgetTypeQuery.widgetTypeId)#" />
	<tr <cfif widget.WidgetTypeQuery.currentRow mod 2 eq 0>class="even"</cfif>>
