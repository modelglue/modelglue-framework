...
<cfset widget.WidgetQuery = viewstate.getValue("widget.WidgetQuery") />
...
<tbody>
<cfif not widget.WidgetQuery.recordcount>
	<tr>
		<cfoutput><td colspan="#displayedColumns#"><em>No Records</em></td></cfoutput>
	</tr>
</cfif>
<cfoutput query="widget.WidgetQuery">
	<cfset keyString = "&widgetId=#urlEncodedFormat(widget.WidgetQuery.widgetId)#" />
	<tr <cfif widget.WidgetQuery.currentRow mod 2 eq 0>class="even"</cfif>>
