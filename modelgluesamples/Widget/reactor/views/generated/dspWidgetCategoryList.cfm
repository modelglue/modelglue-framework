...
<cfset WidgetCategoryQuery = viewstate.getValue("WidgetCategoryQuery") />
...
<tbody>
<cfif not WidgetCategoryQuery.recordcount>
	<tr>
		<cfoutput><td colspan="#displayedColumns#"><em>No Records</em></td></cfoutput>
	</tr>
</cfif>
<cfoutput query="WidgetCategoryQuery">
	<cfset keyString = "&WidgetCategoryId=#urlEncodedFormat(WidgetCategoryQuery.WidgetCategoryId)#" />
	<tr <cfif WidgetCategoryQuery.currentRow mod 2 eq 0>class="even"</cfif>>
